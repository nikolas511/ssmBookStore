...
<html>
  ...
  <body style="background-color: #F5F5DC">
		<form action="${pageContext.request.contextPath}/client/RegisterLoginServlet?method=update" method="post">
		 <table align="left">
		 	<input type="hidden" name="id" value="${user.id }">
		   	...
		   	<tr><td>地址:</td><td><input type="text" name="address" value="${formBean.address }" style="width: 400px"></input>
